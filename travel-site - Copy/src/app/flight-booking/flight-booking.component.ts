...
export class FlightBookingComponent implements OnInit {
  ...
  constructor(
    ...
    private flightsearch: TravelserviceService,
  ...
  searchFlights() {
    ...
    this.flightsearch.searchFlights(this.myForm.value).subscribe(
      (data: any) => {
  ...
  searchroundtrip() {
    this.isloading = true;
    this.flightsearch.searchFlights(this.returnform.value).subscribe(
      (data: any) => {
        this.isloading = false;
